...
document.addEventListener("DOMContentLoaded", () => {
	...
	window.setup = function () {
		...
		// Prevent default scrolling while allowing touch interactions for drawing
		allowCanvasTouch(canvas.elt);
	};

	function allowCanvasTouch(element) {
		element.addEventListener("touchstart", preventDefaultScroll, { passive: false });
